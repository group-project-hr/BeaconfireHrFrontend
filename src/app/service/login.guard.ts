  ...
  canActivate(
    ...
    return new Promise((resolve, reject) => {
      ...
      if (pathName.includes('test')) {
        ...
        !userinfo ||
        !userinfo.basicDataModel ||
        !userinfo.basicDataModel.roleEnum ||
        !userinfo.basicDataModel.userId ||
        !userinfo.basicDataModel.email
      ) {
        if (
          userinfo &&
          userinfo.basicDataModel &&
          userinfo.basicDataModel.roleEnum &&
          userinfo.basicDataModel.roleEnum == RoleEnum.READY_FOR_SIGNUP &&
        ...
        userinfo.basicDataModel.roleEnum == RoleEnum.READY_FOR_APPLICATION_FORM
      ) {
...
const employeeRoutes = new Set<String>()
  ...
  .add('/employee/visa/file/preview')
  .add('/employee/visa')
